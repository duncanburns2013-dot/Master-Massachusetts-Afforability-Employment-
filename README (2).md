...
### 4️⃣ Electricity Crisis

**Source:** EIA Electric Power Monthly, Table 5.6.A (October 2025)

| Metric | Massachusetts | US Average | Premium |
|--------|--------------|------------|---------|
| **Residential** | 31.37¢/kWh | 17.98¢/kWh | **+74%** |
| **Commercial** | 21.98¢/kWh | 13.41¢/kWh | **+64%** |
| **Industrial** | 18.34¢/kWh | 8.65¢/kWh | **+112%** |

**State Rankings (Residential):**
| Rank | State | Rate |
|------|-------|------|
| 1 | Hawaii | 39.74¢ |
| 2 | California | 33.60¢ |
| **3** | **Massachusetts** | **31.37¢** |
| 4 | Rhode Island | 31.16¢ |
| 5 | Maine | 29.42¢ |

**6 of top 10 most expensive = New England states**

**Bill Breakdown (Verified Eversource, Dec 2025):**
| Component | % of Bill |
|-----------|-----------|
| Supply | 40% |
| Distribution | 30% |
| **Public Benefits (Policy)** | **17%** |
| Transmission | 13% |

**Real Bill Examples (17% Policy Charge):**
| Total Bill | Policy Charge | Source |
|------------|---------------|--------|
| $427 | $73/month | WCVB |
| $709 | $121/month | WBUR |
| $853 | $145/month | Boston Globe |

*Note: Additional policy costs embedded in Distribution bring total policy-driven costs to ~29% per State Senator Brownsberger's DPU analysis.*

**Recent Rate Hikes:**
- Eversource: +12.3% (Aug 2025), +5.01% (Feb 2026)
- National Grid gas: +63% (Nov 2024)
